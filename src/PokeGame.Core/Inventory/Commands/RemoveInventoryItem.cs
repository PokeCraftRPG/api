...
internal record RemoveInventoryItemCommand(Guid TrainerId, Guid ItemId, InventoryQuantityPayload Payload) : ICommand<InventoryItemModel>;

internal class RemoveInventoryItemCommandHandler : ICommandHandler<RemoveInventoryItemCommand, InventoryItemModel>
{
  ...
  public RemoveInventoryItemCommandHandler(
    IContext context,
  ...
  public async Task<InventoryItemModel> HandleAsync(RemoveInventoryItemCommand command, CancellationToken cancellationToken)
  {
