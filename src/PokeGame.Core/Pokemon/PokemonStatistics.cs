...
public sealed record PokemonStatistics
{
  ...
  public PokemonStatistics(IBaseStatistics baseStatistics, IIndividualValues individualValues, EffortValues effortValues, int level, PokemonNature nature)
  {
  ...
  public PokemonStatistics(Specimen specimen) : this(specimen.BaseStatistics, specimen.IndividualValues, specimen.EffortValues, specimen.Level, specimen.Nature)
  {
  }
