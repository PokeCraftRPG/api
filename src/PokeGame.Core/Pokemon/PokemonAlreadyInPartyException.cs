...
public class PokemonAlreadyInPartyException : DomainException
{
  private const string ErrorMessage = "The specified Pokémon is already in its trainer party.";
  ...
  public PokemonAlreadyInPartyException(Specimen specimen) : base(BuildMessage(specimen))
  {
