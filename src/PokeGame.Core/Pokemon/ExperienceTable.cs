...
{
  private const int MinimumLevel = Level.MinimumValue;
  ...
  static ExperienceTable()
  {
    ...
    _thresholds[GrowthRate.Erratic] = erratic;
    _thresholds[GrowthRate.Fast] = fast;
    _thresholds[GrowthRate.Fluctuating] = fluctuating;
    _thresholds[GrowthRate.MediumFast] = mediumFast;
    _thresholds[GrowthRate.MediumSlow] = mediumSlow;
    _thresholds[GrowthRate.Slow] = slow;
  }
  ...
  public static int GetLevel(GrowthRate growthRate, int experience)
  {
