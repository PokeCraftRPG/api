...
public class Move : AggregateRoot, IEntityProvider
{
  ...
  public Move(World world, PokemonType type, MoveCategory category, Slug key, PowerPoints powerPoints, UserId? userId = null)
    : this(type, category, key, powerPoints, userId ?? world.OwnerId, MoveId.NewId(world.Id))
  {
  }
