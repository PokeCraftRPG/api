...
namespace PokeGame.PostgreSQL.Migrations
{
    ...
    public partial class CreateSpeciesTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Species_WorldId_CreatedBy",
                schema: "Pokemon",
                table: "Species",
                columns: new[] { "WorldId", "CreatedBy" });

            migrationBuilder.CreateIndex(
                name: "IX_Species_WorldId_CreatedOn",
                schema: "Pokemon",
                table: "Species",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Species_WorldId_UpdatedBy",
                schema: "Pokemon",
                table: "Species",
                columns: new[] { "WorldId", "UpdatedBy" });

            migrationBuilder.CreateIndex(
                name: "IX_Species_WorldId_UpdatedOn",
                schema: "Pokemon",
                table: "Species",
                columns: new[] { "WorldId", "UpdatedOn" });

            migrationBuilder.CreateIndex(
                name: "IX_Species_WorldId_Version",
                schema: "Pokemon",
                table: "Species",
