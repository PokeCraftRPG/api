...
internal static class Species
{
  ...
  public static readonly ColumnId EntityId = new(nameof(SpeciesEntity.EntityId), Table);
  ...
  public static readonly ColumnId WorldId = new(nameof(SpeciesEntity.WorldId), Table);
}
