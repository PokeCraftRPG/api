...
internal class SpeciesRepository : Repository, ISpeciesRepository
{
  ...
  {
    return await base.LoadAsync<PokemonSpecies>(id.StreamId, cancellationToken);
  }
  ...
  {
    return await base.LoadAsync<PokemonSpecies>(ids.Select(id => id.StreamId), cancellationToken);
  }
