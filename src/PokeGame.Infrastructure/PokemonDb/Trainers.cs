...
internal static class Trainers
{
  ...
  public static readonly ColumnId Key = new(nameof(TrainerEntity.Key), Table);
  ...
  public static readonly ColumnId Name = new(nameof(TrainerEntity.Name), Table);
  public static readonly ColumnId Notes = new(nameof(TrainerEntity.Notes), Table);
  public static readonly ColumnId OwnerId = new(nameof(TrainerEntity.OwnerId), Table);
  ...
  public static readonly ColumnId WorldId = new(nameof(TrainerEntity.WorldId), Table);
}
