...
internal static class HttpContextExtensions
{
  ...
  public static WorldDto? GetWorld(this HttpContext context) => context.GetItem<WorldDto>(WorldKey);
  ...
  public static void SetWorld(this HttpContext context, WorldDto? world)
  {
