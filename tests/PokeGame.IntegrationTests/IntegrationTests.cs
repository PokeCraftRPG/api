...
public abstract class IntegrationTests : IAsyncLifetime
{
  ...
  protected virtual async Task ClearDatabaseAsync()
  {
    ...
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Inventory"";");
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Specimens"";");
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Evolutions"";");
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Forms"";");
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Varieties"";");
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Species"";");
    sql.AppendLine(@"DELETE FROM ""Pokemon"".""Trainers"";");
