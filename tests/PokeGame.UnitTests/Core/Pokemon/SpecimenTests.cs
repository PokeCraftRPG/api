...
public class SpecimenTests
{
  ...
  public void Given_InvalidForm_When_ctor_Then_ArgumentException()
  {
    ...
    var exception = Assert.Throws<ArgumentException>(() => new Specimen(_world, _species, _variety, form, _key, _gender));
  ...
  public void Given_InvalidVariety_When_ctor_Then_ArgumentException()
  {
    ...
    var exception = Assert.Throws<ArgumentException>(() => new Specimen(_world, _species, variety, _form, _key, _gender));
  ...
  {
    var exception = Assert.Throws<ArgumentOutOfRangeException>(() => new Specimen(_world, _species, _variety, _form, key: null, (PokemonGender)(-1)));
  ...
  {
    var exception = Assert.Throws<InvalidGenderException>(() => new Specimen(_world, _species, _variety, _form, key: null, gender: null));
  ...
  public void Given_FormWorldMismatch_When_ctor_Then_WorldMismatchException()
  {
    ...
    var exception = Assert.Throws<WorldMismatchException>(() => new Specimen(_species, _variety, form, _key, _gender, _world.OwnerId, specimenId));
  ...
  public void Given_SpeciesWorldMismatch_When_ctor_Then_WorldMismatchException()
  {
    ...
    SpecimenId specimenId = SpecimenId.NewId(_world.Id);
    var exception = Assert.Throws<WorldMismatchException>(() => new Specimen(species, _variety, _form, _key, _gender, _world.OwnerId, specimenId));
    Assert.Equal(specimenId.GetEntity(), exception.Expected);
  ...
  public void Given_VarietyWorldMismatch_When_ctor_Then_WorldMismatchException()
  {
    ...
    SpecimenId specimenId = SpecimenId.NewId(_world.Id);
    var exception = Assert.Throws<WorldMismatchException>(() => new Specimen(_species, variety, _form, _key, _gender, _world.OwnerId, specimenId));
    Assert.Equal(specimenId.GetEntity(), exception.Expected);
