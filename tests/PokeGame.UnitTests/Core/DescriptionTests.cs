...
{
  [Fact(DisplayName = "MaximumLength: it should be 1000.")]
  ...
  [Fact(DisplayName = "TryCreate: it should return a trimmed description for valid text with surrounding padding.")]
