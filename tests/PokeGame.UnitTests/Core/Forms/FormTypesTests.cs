...
public class FormTypesTests
{
  ...
  {
    FormTypes instance = new(PokemonType.Electric, PokemonType.Fairy);
    FormTypes types = new(instance);
  ...
  {
    FormTypes types = new(primary, secondary);
  ...
  public void Given_InvalidArguments_When_ctor_Then_ValidationException()
  {
    ...
    var exception = Assert.Throws<ValidationException>(() => new FormTypes(type, type));
